...
function QuotationTable({ data, clearDataItems, deleteByIndex }) {
    ...
    const totalDiscount = data.reduce((acc, v) => acc + v.qty * v.discount, 0); // Calculate total discount based on quantity
    ...
    return (
        <Container>
            ...
            <Table striped bordered hover>
                ...
                <tbody>
                    {data.map((v, i) => {
                        let amount = v.qty * v.ppu - v.qty * v.discount; // Calculate amount based on quantity and discount
                        return (
                            <tr key={i}>
                                ...
                                <td className={style.textCenter}>{v.discount}</td> {/* Keep individual discount */}
                ...
                <tfoot>
                    <tr>
                        ...
                        <td className={style.textRight}>{totalDiscount}</td> {/* Display total discount */}
                    </tr>
                    <tr>
